  ...
  <div class="container" style="padding-top:200px;">
    ...
    <div class="container" style="padding-top:50px;width:auto">
	   ...
	   <table class="imagetable" align="center">
		<p align="center"><br><br>点击<a href="tea_unfinished.php?p=1">未处理的任务</a>查看教学区未完成的任务。</p>
		<td colspan="11" align="center"><font size="3">教学区已处理任务</font></td>
		<tr>
		  ...
		  $page=$_GET['p'];
		   ...
		   mysqli_query($conn,"SET NAMES UTF8");
			...
			$total_sql="SELECT COUNT(*)FROM teacher where state='已处理'";
			$total_result=mysqli_fetch_array(mysqli_query($conn,$total_sql));
			$total=$total_result[0];
			$total_pages=ceil($total/$pageSize);
					  	
			if($page<$total_pages)
			$sql="SELECT * FROM teacher order by state ASC,finish_time ASC LIMIT ".($page-1)*$pageSize.",{$pageSize}";
			else		 
			{   
				...
				else
				{
			        ...
			        $sql="SELECT * FROM teacher order by state ASC ,finish_time ASC LIMIT ".($page-1)*$pageSize.",{$x}"; //最后一页特殊情况取余
				}
		  ...
		  /*------分页部分-------*/
		   ...
		   $page_banner .= "<form action='tea_finished.php' method='get' class='form-inline my-2 my-lg-0'>";
